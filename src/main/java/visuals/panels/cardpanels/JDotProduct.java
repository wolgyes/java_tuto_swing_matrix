...
public class JDotProduct extends JPanel {

    private JTextField vectorTextField;
    private JTextField vector2TextField;
    private JLabel outputLabel;

    public JDotProduct(int x, int y, int width, int height) {
        super();
    ...
    public void initializeComponents() {
        // Initialize the components
        JLabel label = new JLabel("Dot (INNER) Product", SwingConstants.CENTER);
