...
public class JSubtraction extends JPanel {

    private JTextField vectorTextField;
    private JTextField vector2TextField;
    private JLabel outputLabel;

    public JSubtraction(int x, int y, int width, int height) {
        super();
    ...
    public void initializeComponents() {
        // Initialize the components
        JLabel label = new JLabel("Subtraction", SwingConstants.CENTER);
    ...
    private void HandleCalculate(){
        ...
        XmlManagger.om.vectorCalcs.add(
                new OutputVector(
                        ...
                        vectorObject.calcSubtraction(vector2Object)
                )
        );
        XmlManagger.xmlWrite();
        outputLabel.setText("Result: " + vectorObject.calcSubtraction(vector2Object));
    }
}
